# WebSocket Protocol Implementation Prompt Template

**Document Version:** 1.0.0
**Last Updated:** December 18, 2025
**Purpose:** Standardized prompt template for safe, consistent implementation

---

## ⚠️ CRITICAL: Why This Prompt Exists

This is a **foundational infrastructure change** that will:

- Replace the existing WebSocket implementation entirely
- Set the architectural foundation for AI agent experiences
- Affect every future feature built on this protocol

**There is zero tolerance for:**

- Hallucinated imports or API signatures
- Speculative patterns that don't match the codebase
- Code that compiles but violates Clean Architecture boundaries

---

## The Prompt Template

Copy and customize the following for each implementation task:
...
**Phase:** [1/2/3/4]
**Task ID:** [e.g., B1.1, F2.3, T3.2]
**Task Name:** [e.g., "Create WebSocket Endpoint"]
...
**Phase:** 1
**Task ID:** B1.1
**Task Name:** Create WebSocket Endpoint

**Description:**
Create the FastAPI/Starlette WebSocket endpoint that accepts connections
and delegates to ConnectionManager.

**Acceptance Criteria:**
- [ ] Endpoint at `/ws/conversations/{conversation_id}`
- [ ] Accepts WebSocket upgrade
- [ ] Authenticates user (JWT or session)
...
**Phase:** 2
**Task ID:** B2.3
**Task Name:** Widget State Manager

**Description:**
Create the service that manages widget state across the conversation.

**Acceptance Criteria:**
- [ ] Store widget configs by widget_id
- [ ] Track widget state (idle, active, submitted, etc.)
- [ ] Support state restoration on reconnect

**Dependencies:**
- B2.1 Widget lifecycle handler
- B1.3 Message router
```
...
- [Protocol Essentials](./protocol-essentials.md) - **Condensed behavioral rules (~300 lines)**
- [Pattern Discovery Reference](./pattern-discovery-reference.md) - Verified Neuroglia imports
- [Protocol Specification](../../specs/websocket-protocol-v1.md) - Full message formats (reference only)
- [Implementation Plan](./websocket-protocol-implementation-plan.md) - Phase overview

---

_Use this template for every implementation task to maintain consistency and safety._
