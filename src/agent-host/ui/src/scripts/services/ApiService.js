 ...
 * This is a class-based service following the established singleton pattern.
 *
 * NOTE: This file is the canonical class-based API service.
 * The legacy `api.js` exports the same ApiService instance for backward compatibility.
 *
...
export class ApiService {
    ...
    constructor(baseUrl = '/api') {
        ...
        /** @type {string|null} Track current streaming request for cancellation */
        this.currentRequestId = null;

        /** @type {AbortController|null} AbortController for current request */
        this.abortController = null;

        /** @type {boolean} Suppress during streaming */
        this.suppressUnauthorizedHandler = false;
     ...
     * @param {string} conversationId - Conversation ID
     * @returns {Promise<Object>} Cleared conversation
     */
    ...
    async cancelCurrentRequest() {
        ...
        if (this.currentRequestId) {
            try {
                ...
                console.error('[ApiService] Failed to cancel request on server:', e);
                this.currentRequestId = null;
                return false;
            }
        }
    ...
    /**
     * Get available tools
     * @param {boolean} [forceRefresh=false] - Force refresh from backend
